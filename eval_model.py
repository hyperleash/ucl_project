...
if __name__ == "__main__":
    ...
    word_embedding_path = '/cs/student/msc/dsml/2023/mdavudov/UCB/ICD-MSMN/embedding/word2vec_sg0_100.model' # please add it by yourself

    dev_dataset = MimicFullDataset(version, "dev", word_embedding_path, 4000, summarised=sys.argv[2] == 'summarised')
    dev_dataloader = DataLoader(dev_dataset, batch_size=batch_size, collate_fn=my_collate_fn, shuffle=False, num_workers=1)
    test_dataset = MimicFullDataset(version, "test", word_embedding_path, 4000, summarised=sys.argv[2] == 'summarised')
